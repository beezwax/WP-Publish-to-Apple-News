...
class Component_Factory {
	...
	public static function initialize(
		...
		self::register_component( 'standalone_byline', '\\Apple_Exporter\\Components\\Standalone_Byline' );
		self::register_component( 'publication_date', '\\Apple_Exporter\\Components\\Publication_Date' );
