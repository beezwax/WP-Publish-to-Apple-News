...
<figure class="wp-block-gallery columns-3 is-cropped">
	<ul class="blocks-gallery-grid">
		<li class="blocks-gallery-item">
			<figure>
				<img src="%2\$s" alt="" data-id="%1\$d" data-full-url="%2\$s" data-link="%3\$s" class="wp-image-%1\$d"/>
				<figcaption class="blocks-gallery-item__caption">Test Caption 1</figcaption>
			</figure>
		</li>
		<li class="blocks-gallery-item">
			<figure>
				<img src="%5\$s" alt="" data-id="%4\$d" data-full-url="%5\$s" data-link="%6\$s" class="wp-image-%4\$d"/>
				<figcaption class="blocks-gallery-item__caption">Test Caption 2</figcaption>
			</figure>
		</li>
		<li class="blocks-gallery-item">
			<figure>
				<img src="%8\$s" alt="" data-id="%7\$d" data-full-url="%8\$s" data-link="%9\$s" class="wp-image-%7\$d"/>
...
HTML;
	...
	public function test_component( $post_content ) {
		...
		$images = [
			$this->get_new_attachment( 0, 'Test Caption 1' ),
			$this->get_new_attachment( 0, 'Test Caption 2' ),
			$this->get_new_attachment( 0, 'Test Caption 3' ),
		];
		...
		$this->assertEquals( 'gallery', $json['components'][2]['role'] );
		$this->assertEquals( 3, count( $json['components'][2]['items'] ) );
		$this->assertEquals( wp_get_attachment_image_url( $images[0] ), $json['components'][2]['items'][0]['URL'] );
		$this->assertEquals( 'Test Caption 1', $json['components'][2]['items'][0]['caption']['text'] );
		$this->assertEquals( wp_get_attachment_image_url( $images[1] ), $json['components'][2]['items'][1]['URL'] );
		$this->assertEquals( 'Test Caption 2', $json['components'][2]['items'][1]['caption']['text'] );
		$this->assertEquals( wp_get_attachment_image_url( $images[2] ), $json['components'][2]['items'][2]['URL'] );
		$this->assertEquals( 'Test Caption 3', $json['components'][2]['items'][2]['caption']['text'] );
	}
}
